      ...
      <React.Fragment>
        ...
        <div className="row">
          ...
          <div className="col-sm-12 col-md-6" id="column">
            ...
            <p className="center3">Rajarampuri 5th Lane, in front of Naturals ice-cream, Kolhapur-416211</p>
            <h2 className="center2">
              <i className="fa fa-envelope-o" aria-hidden="true" id="fav"></i>Email
            </h2>
            <p className="center3">onlinegrocery123@gmail.com</p>
            <h2 className="center2">
              <i className="fa fa-phone-square" aria-hidden="true" id="fav"></i>
              Phone
            </h2>
            <p className="center3">+91-9876543210</p>
          </div>
          <div className="col"></div>
        </div>
      </React.Fragment>
